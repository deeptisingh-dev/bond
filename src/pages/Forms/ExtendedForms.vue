    ...
    <div class="extended-forms">
      ...
      <card>
        <div class="col-12">
          <div class="row">
            <div class="col-md-6">
              <h4 class="card-title text-left">Toggle Buttons</h4>
              <div class="row">
            ...
            <div class="col-md-6">
              <h4 class="card-title text-left">Customisable Select</h4>
              <div class="row">
          ...
          <div class="row">
            <div class="col-md-6 text-left">
              <h4 class="card-title text-left">Tags</h4>
              <tags-input v-model="tags.dynamicTags"></tags-input>
            </div>
            <div class="col-md-6">
              <h4 class="card-title text-left">Dropdown &amp; Dropup</h4>
